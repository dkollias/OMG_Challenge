...
class CNN_GRU_3RNN(object):
    ...
    def __init__(self,seq_length,batch_size,h_units=128):
        ...
        self.layers.append(('rnn_fc','40i',self.h_units,False)) 
        self.layers.append(('rnn_last_conv','40ii',self.h_units,False))
        ...
        for layer in self.layers:
            ...
            if layer[0] == 'conv':
                ...
                with tf.variable_scope(name) as scope:
                    ...
                    # if you want to change the dropout value of the fully connected layer, change this value accordingly
                ...
                with tf.variable_scope(name) as scope:
                    ...
                    # if you want to put dropout in the RNN, change the values accordingly
                    cell =  tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.DropoutWrapper(tf.contrib.rnn.GRUCell(self.h_units),input_keep_prob=1,output_keep_prob=1),tf.contrib.rnn.DropoutWrapper(tf.contrib.rnn.GRUCell(self.h_units),input_keep_prob=1,output_keep_prob=1)])
